...
import com.sammengistu.quic.networking.data.source.finance.remote.FinanceRemoteDataSourceImpl
import com.sammengistu.quic.networking.data.source.news.remote.NewsRemoteDataSource
import com.sammengistu.quic.networking.data.source.news.remote.NewsRemoteDataSourceImpl
import com.sammengistu.quic.networking.data.source.weather.remote.WeatherRemoteDataSource
import com.sammengistu.quic.networking.data.source.weather.remote.WeatherRemoteDataSourceImpl
import dagger.Binds
